...
public class Chat extends JFrame implements ActionListener,Serializable
{
  ...
  DefaultListModel lstUserList = new DefaultListModel();
  ...
  public Chat(ChatListener l, String title)
  {
    super(title);
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    {
        Message msg = new Message(this.getTitle(),"ToAll",txtSend.getText());
      listener.onSendMessageToAll(msg);
      txtSend.setText("");
    }
    ...
    {
      JOptionPane.showMessageDialog(null, "Created by Krunal Patel", "Video Conference System", JOptionPane.INFORMATION_MESSAGE);
    }
