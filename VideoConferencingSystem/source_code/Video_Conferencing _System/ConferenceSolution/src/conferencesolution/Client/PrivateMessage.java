...
public class PrivateMessage extends JFrame implements ActionListener,Serializable
{
  ...
  public PrivateMessage(PrivateMessageListener l, String title, String localUser, String remoteUser)
  {
    super(title);
  ...
  public void actionPerformed(ActionEvent e)
  {
    if(e.getSource() == btnSend)
    {
      ...
      System.out.println(localUsername+"-->"+remoteUsername);
      Message msg = new Message(localUsername,remoteUsername,message);
